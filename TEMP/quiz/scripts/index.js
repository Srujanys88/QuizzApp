...
function initApp() {
    const questions = [
        {
            ...
            options: [
                '<script name="xxx.js"sssssssssssssssssss ssssssss ssssssssssss sssssssssssss sssssssssssssss  ssssssssss>',
                '<script src="xxx.js">',
                '<script link="xxx.js">',
                '<script href="xxx.js">'
            ]
    ...
    quiz = new Quiz(
        "Start QUIZ",  
        `Before starting the quiz, please ensure that you have allocated sufficient time in consideration of the total number of questions. Time management is crucial for completing the quiz successfully within the designated timeframe`,
        70,
        questions);
